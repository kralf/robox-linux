...
#define DEBUG_NAME          "TDRV001 : "

#define DRIVER_NAME         "TEWS TECHNOLOGIES - TDRV001 Driver"
...
MODULE_DESCRIPTION("TEWS TDRV001 LowLevel Driver");
#endif
...
static int driver_init(void)
{
     ...
     */
    result = register_chrdev(tp862_major, "tdrv001drv", &tp862_fops);
...
static void driver_cleanup(void)
{
    ...
    printk(KERN_INFO "\n%s TDRV001 driver removed\n", DEBUG_NAME);
    pci_unregister_driver(&tp862_driver);

    unregister_chrdev(tp862_major, "tdrv001drv");
    return;
}
